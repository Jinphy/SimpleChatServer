...
/**
 * This interface is intended to be used by implementors of statement interceptors so that implementors can parse static or dynamic (via
...
public interface ResultSetInternalMethods extends java.sql.ResultSet {
    ...
    /**
     * Sets the first character of the query that was issued to parse
    ...
    /**
     * Returns the first character of the query that was issued to parse this
