 ...
 --------------------------------------------------------------------------------------------
        ...
        DESC: 退出群聊或者解散群聊接口·
                ...
                ☆入参：
                    字段：                 是否必传：           描述
                    1、groupNo             是                  群号
                    2、account             否                  退出群聊的账号，传则删除成员，不传则解散群
                    3、operator            是                  操作者账号
                ☆出参：
                    字段：
        --------------------------------------------------------------------------------------------
        ...
        DESC: 群聊成员把其他成员加入群聊接口·
                ☆接口：/group/addMembers
                ☆请求方式：Post
                ☆入参：
                    字段：                 是否必传：           描述
                    1、groupNo             是                  群号
                    2、accounts            否                  加入群聊的账号
                    3、operator            是                  操作者账号
                ☆出参：
                    字段：
        --------------------------------------------------------------------------------------------
        ...
        DESC: 退出群聊或者解散群聊接口·
                ☆接口：/group/removeMembers
                ☆请求方式：Post
                ☆入参：
                    字段：                 是否必传：           描述
                    1、groupNo             是                  群号
                    2、accounts            否                  退出群聊的账号数组
                    3、operator            是                  操作者账号
                ☆出参：
                字段：
        --------------------------------------------------------------------------------------------
        ...
        --------------------------------------------------------------------------------------------
         ...
         DESC: 获取群成员接口
                ☆接口：/member/modifyAllowChat
                ☆请求方式：Post
                ☆入参：
                    字段：                 是否必传：           描述
                    1、groupNo             是                  群号
                    2、account            是                  成员账号
                    3、allowChat           是                  是否允许发言
                    4、creator             是                  群主
                ☆出参：
                    字段：
         --------------------------------------------------------------------------------------------
        ...
        DESC: 发送消息接口
                ...
                ☆入参：
                    字段：                 是否必传：           描述
                    1、fromAccount         是                  发送账号
                    2、toAccount           是                  接收账号
                    3、createTime          是                  消息的发送时间
                    4、content             是                  消息的内容
                    5、contentType         是                  消息类型
                    6、extra               是                  extra字段
                ☆出参：
                    字段：
        --------------------------------------------------------------------------------------------
